...
import { getSeoAuditReport } from "@/lib/data";
import { formatDate, severityColor } from "@/lib/utils";

export const dynamic = "force-dynamic";

export default async function SeoAuditDatePage({
  params,
}: {
  ...
  return (
    <>
      <Header
        title={`SEO Audit — ${formatDate(date)}`}
        description={report.page_url}
      />
          ...
          <div className="space-y-2 mb-6">
            {report.aeo_analysis.paa_targets.map((paa) => (
              ...
              >
                ...
                <h4 className="mt-1 text-sm font-medium text-neutral-200">
                  {paa.question}
                </h4>
